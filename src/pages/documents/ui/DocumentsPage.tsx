...
const userDocuments: Document[] = [
  { key: '1', name: 'Personal Notes.docx', modified: '2 days ago', createdBy: 'John Smith', modifiedBy: 'Jane Doe', owner: 'me', shared: false, status: 'Active' },
  ...
  { key: '3', name: 'Personal Budget.xlsx', modified: '3 days ago', createdBy: 'Mike Brown', modifiedBy: 'Sarah Davis', owner: 'me', shared: false, status: 'Active' },
];
