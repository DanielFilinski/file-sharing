...
- [ ] Создать схему Azure SQL Database (пользователи, роли, организации)
- [ ] Настроить CosmosDB контейнеры (документы, чаты, аудит)
- [ ] Настроить миграции и индексы для обеих БД
- [ ] Создать API для всех сущностей (Users, Offices, Departments, Clients)
- [ ] Интегрировать Microsoft Graph API
- [ ] Обновить хуки сущностей для работы с API
- [ ] Настроить синхронизацию Azure AD ↔ Azure SQL
- [ ] Добавить валидацию и обработку ошибок
- [ ] Создать тесты для API сущностей
